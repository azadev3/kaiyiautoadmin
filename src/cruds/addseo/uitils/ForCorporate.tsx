...
const ForCorporate: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await axios.post(`${endpoint}/forcorporate-seo`, data);
            if (res.data) {
    ...
    React.useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${endpoint}/forcorporate-seo`);
                if (response) {
    ...
    return (
        <form onSubmit={handleSubmit} acceptCharset='UTF-8' className='accordion-content'>
            <div className="input-field">
                <label htmlFor="">Korporativ Müştərilər Üçün Səhifəsi <strong>meta başlıq</strong> (AZ)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Korporativ Müştərilər Üçün Səhifəsi <strong>meta başlıq</strong> (EN)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Korporativ Müştərilər Üçün Səhifəsi <strong>meta başlıq</strong> (RU)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Korporativ Müştərilər Üçün Səhifəsi <strong>meta açıqlama</strong> (AZ)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Korporativ Müştərilər Üçün Səhifəsi <strong>meta açıqlama</strong> (EN)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Korporativ Müştərilər Üçün Səhifəsi <strong>meta açıqlama</strong> (RU)</label>
