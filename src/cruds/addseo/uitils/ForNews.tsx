...
const ForNews: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const res = await axios.post(`${endpoint}/new-seo`, data);
            if (res.data) {
    ...
    React.useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${endpoint}/new-seo`);
                if (response) {
    ...
    return (
        <form onSubmit={handleSubmit} acceptCharset='UTF-8' className='accordion-content'>
            <div className="input-field">
                <label htmlFor="">Yeniliklər səhifəsi <strong>meta başlıq</strong> (AZ)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Yeniliklər səhifəsi <strong>meta başlıq</strong> (EN)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Yeniliklər səhifəsi <strong>meta başlıq</strong> (RU)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Yeniliklər səhifəsi <strong>meta açıqlama</strong> (AZ)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Yeniliklər səhifəsi <strong>meta açıqlama</strong> (EN)</label>
            ...
            <div className="input-field">
                <label htmlFor="">Yeniliklər səhifəsi <strong>meta açıqlama</strong> (RU)</label>
