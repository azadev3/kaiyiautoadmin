...
const AddSocialEdit: React.FC = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: "link", headerName: "URL (link)", width: 260 },
    {
      field: "status",
      headerName: "Status",
      width: 150,
  ...
  const EditModal: React.FC<Props> = (props) => {
    ...
    const handleEdit = async (e: React.FormEvent, id: string) => {
      ...
      try {
        const response = await axios.put(`${endpoint}/add-socials/${id}`, formData, {
          headers: {
        ...
        <div className="edit-container">
          <form acceptCharset="UTF-8" onSubmit={(e: React.FormEvent) => handleEdit(e, props?.data?._id)}>
            ...
            <InputField
              ...
              value={link}
            />
            <InputImageField req={false} labelTitle="İkon yükləyin" onChange={handleUpdateImage} />
