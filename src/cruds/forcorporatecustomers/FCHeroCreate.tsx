...
const FCHeroCreate: React.FC = () => {
  ...
  const { refetch } = useQuery<DataTypeCorporateCustomers[]>({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${endpoint}/for-corporate-customers`, formData, {
        headers: {
