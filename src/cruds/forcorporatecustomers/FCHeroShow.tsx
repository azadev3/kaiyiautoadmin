...
export type DataTypeCorporateCustomers = {
  _id: string;
  title: {
    az: string;
    en: string;
...
const FCHeroShow: React.FC = () => {
  ...
  const isTableModal =
    hasData &&
    fetchData?.find((data: DataTypeCorporateCustomers) => {
  ...
  const updateStatus = async (id: string, newStatus: string) => {
    try {
      const response = await axios.post(`${endpoint}/status-update-for-corporate-customers/${id}`, {
        status: newStatus,
      });
                    ...
                    <td>
                      <div className={`status-btn ${data?.status === "active" ? "actived" : ""}`}>
                        ...
                        <StatusToggle
                          ...
                          api="/status-for-corporate-customers"
                        />
                      </div>
                    </td>
                    <td>{data?._id}</td>
