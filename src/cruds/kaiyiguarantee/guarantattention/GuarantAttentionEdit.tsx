...
type Props = {
  data: DataTypeGuarantAttention;
};

const GuarantAttentionEdit: React.FC = () => {
  ...
  const EditModal: React.FC<Props> = (props) => {
    ...
    const handleEdit = async (e: React.FormEvent, id: string) => {
      ...
      try {
        const response = await axios.put(`${endpoint}/guarantattention/${id}`, formData, {
          headers: {
...
export default GuarantAttentionEdit;
