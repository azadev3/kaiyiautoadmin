...
const GuarantHeroCreate: React.FC = () => {
  ...
  const { refetch } = useQuery<DataTypeGuarantHero[]>({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${endpoint}/guaranthero`, formData, {
        headers: {
  ...
  return (
    <form acceptCharset="UTF-8" onSubmit={handleSubmit}>
      <InputField
        value={titleAz}
        label="KAIYI Qarantiya Xidməti Hero Başlıq (AZ)"
        placeholder="Məsələn: Example data..."
        onChange={(e: ChangeEvent<HTMLInputElement>) => setTitleAz(e.target.value)}
      />
      <InputField
        label="KAIYI Qarantiya Xidməti Hero Başlıq (EN)"
        placeholder="Məsələn: Example data..."
        value={titleEn}
        onChange={(e: ChangeEvent<HTMLInputElement>) => setTitleEn(e.target.value)}
      />
      <InputField
        label="KAIYI Qarantiya Xidməti Hero Başlıq (RU)"
        placeholder="Məsələn: Example data..."
        onChange={(e: ChangeEvent<HTMLInputElement>) => setTitleRu(e.target.value)}
        value={titleRu}
      />
      <InputField
        label="KAIYI Qarantiya Xidməti Hero Açıqlama (AZ) (maksimum: 80 hərf)"
        placeholder="Məsələn: Example data..."
      ...
      />
      <InputField
        label="KAIYI Qarantiya Xidməti Hero Açıqlama (EN) (maksimum: 80 hərf)"
        placeholder="Məsələn: Example data..."
      ...
      />
      <InputField
        label="KAIYI Qarantiya Xidməti Hero Açıqlama (RU) (maksimum: 80 hərf)"
        placeholder="Məsələn: Example data..."
...
export default GuarantHeroCreate;
