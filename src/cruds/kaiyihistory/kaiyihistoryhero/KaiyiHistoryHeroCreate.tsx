...
const KaiyiHistoryHeroCreate: React.FC = () => {
  ...
  const { refetch } = useQuery<DataTypeKaiyiHistoryHero[]>({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${endpoint}/kaiyi-history-hero`, formData, {
        headers: {
...
export default KaiyiHistoryHeroCreate;
