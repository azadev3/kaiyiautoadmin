...
const ModelComfortCreate: React.FC = () => {
  ...
  const { refetch } = useQuery<DataTypeModelComfort[]>({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${endpoint}/modelcomfortab`, formData, {
        headers: {
...
export default ModelComfortCreate;
