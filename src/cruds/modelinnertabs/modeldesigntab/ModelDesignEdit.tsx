...
type Props = {
  data: DataTypeModelDesignTab;
};

const ModelDesignEdit: React.FC = () => {
  ...
  const EditModal: React.FC<Props> = (props) => {
    ...
    const handleEdit = async (e: React.FormEvent, id: string) => {
      ...
      try {
        const response = await axios.put(`${endpoint}/modeldesigntab/${id}`, formData, {
          headers: {
...
export default ModelDesignEdit;
