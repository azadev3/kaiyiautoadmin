...
const ModelSecTabCreate: React.FC = () => {
  ...
  const { refetch } = useQuery<DataTypeModelSecTab[]>({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${endpoint}/modelsectab`, formData, {
        headers: {
...
export default ModelSecTabCreate;
