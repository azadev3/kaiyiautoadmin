...
type Props = {
  data: DataTypeComfortable;
};

const ComfortableEdit: React.FC = () => {
  ...
  const EditModal: React.FC<Props> = (props) => {
    ...
    const handleEdit = async (e: React.FormEvent, id: string) => {
      ...
      try {
        const response = await axios.put(`${endpoint}/comfortabletab/${id}`, formData, {
          headers: {
...
export default ComfortableEdit;
