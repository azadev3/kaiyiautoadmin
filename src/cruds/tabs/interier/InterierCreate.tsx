...
const InterierCreate: React.FC = () => {
  ...
  const { refetch } = useQuery<DataTypeInterier[]>({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${endpoint}/interiertab`, formData, {
        headers: {
