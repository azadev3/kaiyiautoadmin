...
type Props = {
  data: DataTypeTrafficRulesHelped;
};

const TrafficRulesHelpedEdit: React.FC = () => {
  ...
  const EditModal: React.FC<Props> = (props) => {
    ...
    const handleEdit = async (e: React.FormEvent, id: string) => {
      ...
      try {
        const response = await axios.put(`${endpoint}/traffic-rules-helped/${id}`, formData, {
          headers: {
      ...
      <div className="edit-modal">
        ...
        <div className="edit-container">
          <form acceptCharset="UTF-8" onSubmit={(e: React.FormEvent) => handleEdit(e, props?.data?._id)}>
            ...
            <InputImageField labelTitle="İkon" req={false} onChange={handleUpdateImage} name="img" />
...
export default TrafficRulesHelpedEdit;
